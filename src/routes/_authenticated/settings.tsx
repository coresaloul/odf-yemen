...
export const Route = createFileRoute("/_authenticated/settings")({
  ...
  head: () => ({
    meta: [
      { title: "تفضيلات الإشعارات | مدير" },
      {
        name: "description",
        content:
          "تحكّم في إشعارات النظام والبريد الإلكتروني لمهامك وتقييماتك في مدير — نظام الموارد البشرية والتخطيط والتقارير.",
      },
      { property: "og:title", content: "تفضيلات الإشعارات | مدير" },
      {
