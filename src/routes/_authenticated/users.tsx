...
const ALL_ROLES = [
  ...
  { value: "secretariat", label: "السكرتارية" },
...
const ROLE_MATRIX: { role: string; scope: string; abilities: string }[] = [
  {
    ...
    scope: "كامل النظام",
    abilities:
      "كل العمليات: الهيكل، الموظفون، المستخدمون والأدوار، المهام، التقييم والاعتماد النهائي للمسيرات والقرارات",
  },
  {
    role: "الموارد البشرية",
    scope: "كل الموظفين والعمليات",
    abilities:
      "الموظفون والوثائق، الدوام والورديات، مسيرات الرواتب، التهيئة والإنهاء، إنشاء الحسابات، واعتماد المرحلة الثانية",
  },
  {
    role: "مدير مباشر",
    scope: "إدارته / قسمه",
    abilities: "تكليف ومتابعة مهام فريقه، اعتماد طلبات الإجازات والتصحيحات، وتقييم موظفي وحدته",
  },
  {
    role: "السكرتارية",
    scope: "المراسلات والأرشفة",
    abilities: "تسجيل وقيد وتوزيع وأرشفة المراسلات الصادرة والواردة ومتابعة مسار المعاملات",
  },
  { role: "موظف", scope: "بياناته وخدمته الذاتية", abilities: "تنفيذ مهامه، طلب الإجازات والنماذج، الاطلاع على دوامه وقسائم رواتبه وتقييماته" },
];
