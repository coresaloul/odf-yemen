...
CREATE INDEX IF NOT EXISTS idx_audit_log_created_entity
  ON public.audit_log (created_at DESC, entity);

-- 5. حصر تنفيذ دالة التحليلات على المستخدمين المسجّلين فقط
