    ...
    <div className="space-y-3 rounded-lg border bg-card p-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Select value={value.assignee} onValueChange={(v) => set("assignee", v)}>
          <SelectTrigger className="w-44"><SelectValue placeholder="الموظف" /></SelectTrigger>
          <SelectContent>
        ...
        <Select value={value.department} onValueChange={(v) => set("department", v)}>
          <SelectTrigger className="w-44"><SelectValue placeholder="الإدارة" /></SelectTrigger>
          <SelectContent>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Input type="date" className="w-40" value={value.from} onChange={(e) => set("from", e.target.value)} />
        <span className="text-xs text-muted-foreground">إلى</span>
        <Input type="date" className="w-40" value={value.to} onChange={(e) => set("to", e.target.value)} />
