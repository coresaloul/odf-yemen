...
CREATE TABLE IF NOT EXISTS public.correspondence_approvals (
  ...
  stage text NOT NULL CHECK (stage IN ('pending_manager', 'pending_secretariat', 'pending_director')),
...
DROP POLICY IF EXISTS correspondence_approvals_read ON public.correspondence_approvals;
