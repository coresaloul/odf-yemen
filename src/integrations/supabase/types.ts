...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      app_role: "executive_director" | "manager" | "employee" | "hr" | "secretariat";
      approval_stage:
        "draft" | "pending_manager" | "pending_hr" | "pending_director" | "approved" | "returned";
      attendance_status: "present" | "absent" | "leave" | "holiday" | "permission";
      custody_asset_status:
        "available" | "assigned" | "maintenance" | "damaged" | "written_off" | "lost";
      ...
      task_status: "new" | "in_progress" | "completed" | "cancelled" | "pending_approval";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
