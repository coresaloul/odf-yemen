...
> **تستخدم جهاز Windows؟** اتبع الدليل المخصص: [WINDOWS.md](./WINDOWS.md) — تهيئة كاملة بنقرة واحدة عبر `deploy/windows/setup.ps1` دون كتابة أي أوامر Linux.
>
> **ملاحظة عن Hostinger:** الاستضافة المشتركة (Web Hosting / Premium / Business) لا تشغّل هذا النظام لأنها تدعم PHP وMySQL فقط، بينما النظام يحتاج Node.js وPostgreSQL. الخيار المتاح لدى Hostinger هو **VPS** (يُنصح بـ KVM 2 مع قالب Ubuntu 24.04 + Docker) وتُتبع معه خطوات هذا الملف كما هي.
