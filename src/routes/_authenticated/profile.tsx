...
export const Route = createFileRoute("/_authenticated/profile")({
  ...
  head: () => ({
    meta: [
      { title: "ملفي الشخصي | نظام الموارد البشرية" },
      {
        name: "description",
        content:
          "اطّلع على بياناتك الوظيفية وحدّث بياناتك الشخصية والصحية وبيانات الطوارئ في نظام الموارد البشرية لمؤسسة اليتيم التنموية.",
      },
      { property: "og:title", content: "ملفي الشخصي | نظام الموارد البشرية" },
      {
